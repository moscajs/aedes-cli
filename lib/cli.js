...
yargs
  ...
  .example('aedes adduser user1 password1', 'Add/Modify user1 with password1 to credentials')
  .example('aedes rmuser user1', 'Removes user1 from credentials')
  .help()
  .locale('us')
  .alias('h', 'help')
 ...
 * @param {Function} handle Broker handle function
 */
 ...
 * @api private
 */
module.exports = function cli (cliArgs) {
